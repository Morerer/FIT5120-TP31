    ...
    <div className="min-h-screen bg-cover bg-center text-white" style={{ backgroundImage: `url('/background.jpg')` }}>
      ...
      <main className="flex flex-col items-center justify-center text-center py-32 px-4">
        ...
        <div className="mt-8 flex flex-wrap gap-4">
          <button className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg">Trends</button>
          <button className="bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-lg">Insights</button>
