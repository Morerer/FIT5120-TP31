      ...
      <div className="w-full max-w-6xl">
        ...
        <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          <CardLink
            to="/map"
            title="Map"
            desc="Live traffic across Melbourne CBD."
      ...
      <div className="h-full rounded-2xl border border-slate-200 bg-white shadow-sm transition hover:-translate-y-0.5 hover:shadow-md">
        <div className="p-5">
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs font-medium text-slate-600 bg-slate-100 px-2 py-1 rounded-md group-hover:bg-slate-200">
              
            </span>
          </div>
          <p className="mt-1 text-sm text-slate-600">{desc}</p>
          <div
            className={`mt-4 h-28 rounded-md bg-gradient-to-br ${accent} flex items-center justify-center`}
          >
            {icon}
          </div>
        </div>
